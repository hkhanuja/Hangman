...
checkpoint = torch.load('bert_rl_custom_reward/bert_rl_custom_reward_model_epoch_490000.pth', map_location=device)  
...
with open("bert_rl_custom_reward/bert_rl_custom_reward_correct_words.txt", "w") as f:
